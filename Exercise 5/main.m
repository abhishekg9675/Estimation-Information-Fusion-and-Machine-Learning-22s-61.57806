...
function main(Theta)
    ...
    Q = proNoise*[ ...
        (delT^3)/3 0 (delT^2)/2 0; ...
        0 (delT^3)/3 0 (delT^2)/2; ...
        (delT^2)/2 0 delT 0; ...
        0 (delT^2)/2 0 delT];  % State transition noise matrix
    
    sigmaRange = 5; % Measurement error standard deviation in range
    sigmaTheta = Theta*pi/180; % Measurement error standard deviation in angle
